...
#link for dataset
#https://www.kaggle.com/datasets/eb9594e5b728b2eb74ff8d5e57a9b74634330bfa79d9195d6ebdc7745b9802c3?resource=download

train_df = pd.read_csv("mnist/train.csv")
test_df = pd.read_csv("mnist/test.csv")
print("===================================")
train_images = os.getcwd() + "/mnist/train_images/" + train_df.iloc[:, 0].values
test_images = os.getcwd() + "/mnist/test_images/" + test_df.iloc[:, 0].values
